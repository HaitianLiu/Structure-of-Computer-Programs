...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        step = self.min_range
        while step <= self.max_range and check_place != beehive:
...
class QueenAnt(ScubaThrower):  # You should change this line
    ...
    def action(self, gamestate):
        ...
        if self.real_queen == False:
            ...
            while place.exit:
                place = place.exit
                if place.ant and place.ant.double == False:
                    place.ant.damage *= 2
                    place.ant.double = True
                if isinstance(place.ant, ContainerAnt) and place.ant.contained_ant and place.ant.contained_ant.double == False:
...
def apply_effect(effect, bee, duration):
    ...
    def new_action(gamestate):
        ...
        duration -= 1
        if duration >= 0:
            effect(original_action, bee)(gamestate)
