...
def roll_dice(num_rolls, dice=six_sided):
    ...
    while roll_times <= num_rolls:
        ...
        if x==1:
            ...
            roll_sum += x
        roll_times += 1
    return (value and 1) or roll_sum
    # END PROBLEM 1
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        ...
        if feral_hogs:
            if abs(num_rolls - new_add0) == 2 and who == 0:
                score0 += 3
                new_add0 = add0
            elif abs(num_rolls - new_add1) == 2 and who == 1:
                score1 += 3
                new_add1 = add1
            else:
                if who == 0:
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    for i in range(1,11):
        average.append(averaged_dice(i,dice))
